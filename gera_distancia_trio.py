...
with open("Samples/Measurements/Tree_To_One/blackboard/d25/1m_315g.txt", mode='w') as f:
...
while(cont<70):
	...
	print cont,1
		...
		print bl1.resBeacon.rssi,bl2.resBeacon.rssi,bl3.resBeacon.rssi
                with open("Samples/Measurements/Tree_To_One/blackboard/d25/1m_315g.txt", mode='a') as f:
